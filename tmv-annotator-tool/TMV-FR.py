            ...
            if (curr_pos in verbal_tags):
               ...
               if i not in fin_pos:
                  ...
                  if curr_pos == "ADV" and curr_token in ["ne", "n'", "pas", "non"]:
                     ...
                     temp_res[str(i)+"#"+curr_pos+"#"+curr_rel+"#"+curr_morph+"#"+curr_token+"#"+curr_lemma+"#"+str(last_fin_pos)] = createDepDict(i, fin_pos, last_fin_pos, inf_vcs, coord, dep_dict)
               ...
               if curr_pos == "P":
                  if curr_lemma in ["de", "à", "par", "en", "pour"]:
                     if checkPasseRec(fp, last_fin_pos, pos_dict):
                        res[str(fp)+"#"+curr_pos+"#"+curr_rel+"#"+curr_morph+"#"+curr_token+"#"+curr_lemma+"#"+str(last_fin_pos)] = createDepDict(fp, fin_pos, fp, inf_vcs, coord, dep_dict)
   ...
   for fp in fin_pos:
      ...
      if curr_pos == "P":
         if curr_lemma in ["de", "à", "par", "en", "pour"]:
            ...
            if (checkInf(dep_dict[fp], dep_dict, pos_dict) or checkGer(dep_dict[fp], dep_dict, pos_dict)) and not checkPasseRec(fp, last_fin_pos, pos_dict):
               res[str(fp)+"#"+curr_pos+"#"+curr_rel+"#"+curr_morph+"#"+curr_token+"#"+curr_lemma+"#"+str(last_fin_pos)] = createDepDict(fp, fin_pos, fp, inf_vcs, coord, dep_dict)
         ...
         last_fin_pos = fp
         res[str(fp)+"#"+curr_pos+"#"+curr_rel+"#"+curr_morph+"#"+curr_token+"#"+curr_lemma+"#"+str(last_fin_pos)] = createDepDict(fp, fin_pos, last_fin_pos, inf_vcs, coord, dep_dict)
...
def getTenseFR(chain_dict):
   ...
   def deriveTMFR(pos_seq, fin, chain_dict):
	 ...
	 intransSharid = [u"aller", u"arriver", u"décéder", u"devenir", u"échoir", u"entrer", u"mourir", u"naître", u"partir", u"rester", u"retourner", u"sortir", u"tomber", u"venir"]

         intrans = ["aller", "arriver", "décéder", "descendre", "demeurer", "devenir", "être", "échoir", "entrer", "monter", "mourir", "naître", "partir", "passer", "quitter", "rencontrer", "rester", "retourner", "sortir", "tomber", "venir"]
...
def extractVerbDeps(parsed_file):
    ...
    while parsed_line:
        ...
        print "Derving TMV for French ...", sent_nr, "\r",
